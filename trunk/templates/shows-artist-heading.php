...
<?php if(!empty($gpo['display_subscriptions'])) : ?>
	<span class="gigpress-artist-subscriptions">
		...
		&nbsp;
		<a href="<?php echo GIGPRESS_WEBCAL . '&amp;artist=' . $showdata['artist_id']; ?>" title="<?php echo $showdata['artist_plain']; ?> iCalendar"><img src="<?php echo WP_PLUGIN_URL; ?>/gigpress/images/icalendar-icon.gif" alt="" /></a>
	</span>
<?php endif; ?>
</h3>