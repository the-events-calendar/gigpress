...
if( !defined( 'GIGPRESS_SHOWS' ) ) define( 'GIGPRESS_SHOWS', $wpdb->prefix . 'gigpress_shows' );
if( !defined( 'GIGPRESS_TOURS' ) ) define( 'GIGPRESS_TOURS', $wpdb->prefix . 'gigpress_tours' );
if( !defined( 'GIGPRESS_ARTISTS' ) ) define( 'GIGPRESS_ARTISTS', $wpdb->prefix . 'gigpress_artists' );
if( !defined( 'GIGPRESS_VENUES' ) ) define( 'GIGPRESS_VENUES', $wpdb->prefix . 'gigpress_venues' );
if( !defined( 'GIGPRESS_VERSION' ) ) define( 'GIGPRESS_VERSION', '2.3.21' );
if( !defined( 'GIGPRESS_DB_VERSION' ) ) define( 'GIGPRESS_DB_VERSION', '1.6' );
if( !defined( 'GIGPRESS_RSS' ) ) define( 'GIGPRESS_RSS', get_bloginfo( 'url' ) . '/?feed=gigpress' );
if( !defined( 'GIGPRESS_ICAL' ) ) define( 'GIGPRESS_ICAL', get_bloginfo( 'url' ) . '/?feed=gigpress-ical' );
if( !defined( 'GIGPRESS_WEBCAL' ) ) define( 'GIGPRESS_WEBCAL', str_replace( 'http://', 'webcal://', GIGPRESS_ICAL ) );
if( !defined( 'GIGPRESS_DEBUG' ) ) define( 'GIGPRESS_DEBUG', true);

require( 'admin/db.php' );

if( !defined( 'GIGPRESS_URL' ) ) define( 'GIGPRESS_URL', ( $gpo['shows_page'] ) ? esc_url( $gpo['shows_page'] ) : get_bloginfo( 'url' ) );
