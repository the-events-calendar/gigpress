...
// view all now in footer
	...
	if ($scope == 'past') // program_name set above or in shows-list-empty
	{
...
function output_shows_markup_json($shows_markup)
{
			if(!empty($shows_markup))
			{
				echo '<div class=hide><script type="application/ld+json">';
